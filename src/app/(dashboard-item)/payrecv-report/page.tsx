...
const Page = () => {
    ...
    useEffect(() => {
        fetch(`${apiBaseUrl}/payment/getMonthlyPaymentRecord?username=${username}`)
    ...
    useEffect(() => {
        ...
        const filtered = allProducts.filter(product =>
          searchWords.every(word =>
            ...
            (product.paymentName?.toLowerCase().includes(word) || '') ||
    ...
    return (
        <div className="container-2xl">
            <div className="flex flex-col w-full  min-h-[calc(100vh-228px)] items-center justify-center p-4">
                <div className="flex p-5"><DateToDate routePath="/datewise-payrecv-report" /></div>
                    ...
                    <div className="overflow-x-auto items-center justify-center">
                        <div ref={contentToPrint} className="flex-1 p-5">
                            <div className="flex flex-col items-center pb-5"><h4 className="font-bold">PAY-RECV REPORT</h4><CurrentMonthYear /></div>
