...
const Page = () => {
    ...
    useEffect(() => {
        fetch(`${apiBaseUrl}/payment/getDatewise-payrecev-details?username=${encodeURIComponent(username)}&paymentName=${encodeURIComponent(paymentName ?? "")}&fromDate=${startDate}&toDate=${endDate}`)
    ...
    }, [apiBaseUrl, username, paymentName, startDate, endDate]);
                ...
                <div className="overflow-x-auto items-center justify-center">
                    <div ref={contentToPrint} className="flex-1 p-5">
                        <div className="flex flex-col items-center pb-5">
                            <h4 className="font-bold">PAY-RECEIVE REPORT</h4>
                            <h5 className="font-bold uppercase">{paymentName}</h5>
                            <h5 className="font-bold capitalize">DATE: {startDate} TO {endDate}</h5>
