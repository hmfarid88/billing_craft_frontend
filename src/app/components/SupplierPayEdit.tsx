...
const SupplierPayEdit = () => {
    ...
    useEffect(() => {
        fetch(`${apiBaseUrl}/payment/getLast7daysSupplierPayment?username=${username}`)
        ...
        <div className="flex min-h-64">
            <div className="flex flex-col gap-3 items-center w-full">
                <label className="form-control w-full max-w-xs">
                    ...
                    <Select className="text-black" onChange={(selectedOption: any) => setPaymentno(selectedOption.value)} options={paymentOption} maxMenuHeight={400}
                        menuPlacement="auto"
